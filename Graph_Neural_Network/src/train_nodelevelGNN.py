from models import MLPModel, GNNModel
import os
...
save_file = os.path.join(model_path,"output/gnn/model_gnn.p") 
...
if __name__ == "__main__":
    ...
    print(num_node, c_in)
    model = GNNModel(c_in=c_in, c_out=num_classes, c_hidden=16)
